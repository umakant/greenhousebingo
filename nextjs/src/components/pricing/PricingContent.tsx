      ...
      <section className="px-6 pt-16 pb-10 sm:pt-24 sm:pb-16">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-base text-muted-foreground sm:text-lg">
            Start a 30-day free trial to test all the features that come with our plans.
            ...
            <div className="grid gap-6 md:grid-cols-3">
              {plans.map((plan) => (
                ...
                >
                  ...
                  <div className="mt-10">
                    <p className="flex flex-nowrap items-baseline gap-x-1.5">
                      <span className="shrink-0 text-2xl font-bold tracking-tight text-foreground tabular-nums sm:text-3xl">
                        ${plan.price}
                      </span>
                      <span className="shrink-0 text-xs text-muted-foreground sm:text-sm">{plan.period}</span>
                    </p>
                  </div>
      ...
      <section id="faq" className="border-t border-border bg-muted/30 px-6 py-20">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-10 space-y-4">
            {[
              { q: "Do I need a credit card to start the trial?", a: "No. Start your 30-day trial with just an email — we'll only ask for payment when you're ready to keep going." },
