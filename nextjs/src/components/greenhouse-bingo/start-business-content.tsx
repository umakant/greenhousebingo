...
const heroImage = "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?auto=format&fit=crop&w=1600&q=80";
...
import {
  ...
  OneDashboard,
  GetPaidInstantly,
} from "@/components/greenhouse-bingo/start-business-extras";
