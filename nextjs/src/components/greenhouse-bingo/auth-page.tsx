        ...
        <Tabs defaultValue="login" className="w-full">
          ...
          <TabsContent value="login" className="mt-6 space-y-4">
            <div>
              ...
              <Input id="l-email" type="email" required className="mt-1.5" />
            </div>
            <div>
              <Label htmlFor="l-pw">Password</Label>
              <Input id="l-pw" type="password" required className="mt-1.5" />
            </div>
          ...
          <TabsContent value="signup" className="mt-6 space-y-4">
            ...
            <div>
              ...
              <Input id="s-pw" type="password" required className="mt-1.5" />
            </div>
