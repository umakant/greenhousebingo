...
export async function PosPageWrapper({ children, pageTitle, breadcrumbs }: PosPageWrapperProps) {
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={breadcrumbs ?? [{ label: "Dashboard", url: "/pos/dashboard" }, { label: pageTitle }]}
    >
      {children}
    </AuthenticatedLayout>
  );
