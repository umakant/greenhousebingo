import { resourceColumns } from "./resourcesData";
      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_1fr_1fr_1.1fr]">
          ...
          <div className="rounded-2xl bg-muted/60 p-6 lg:-my-2">
            <h3 className="mb-5 text-lg font-bold text-foreground">Achieve More</h3>
            <div className="space-y-4">
              <ResourceCard tag="Help Center" title="Help Center" subtitle="Find the fastest answers to your app questions." />
              <ResourceCard tag="Affiliate" title="Affiliate Program" subtitle="Promote Paper Flight & earn 40% commissions." />
            </div>
          </div>
        </div>
...
function ResourceCard({ tag, title, subtitle }: { tag: string; title: string; subtitle: string }) {
  return (
