...
import PosProductsClient from "./client";
...
export default async function PosProductsPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Products" breadcrumbs={[{ label: "Accounting", url: "/account" }, { label: "Products" }]}>
      <PosProductsClient />
    </AuthenticatedLayout>
  );
}
