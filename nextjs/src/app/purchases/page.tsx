...
import PosPurchasesClient from "./client";
...
export default async function PosPurchasesPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Purchases" breadcrumbs={[{ label: "POS Dashboard", url: "/pos/dashboard" }, { label: "Purchases" }]}>
      <PosPurchasesClient />
    </AuthenticatedLayout>
  );
}
