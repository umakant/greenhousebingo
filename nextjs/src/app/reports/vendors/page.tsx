...
import VendorsReportClient from "./client";
...
export default async function VendorsReportPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Vendors Report" breadcrumbs={[{ label: "POS Dashboard", url: "/pos/dashboard" }, { label: "Reports", url: "/reports/sales" }, { label: "Vendors" }]}>
      <VendorsReportClient />
    </AuthenticatedLayout>
  );
}
