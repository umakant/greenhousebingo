...
export default async function ProfitLossPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Profit & Loss" breadcrumbs={[{ label: "POS Dashboard", url: "/pos/dashboard" }, { label: "Reports", url: "/reports/sales" }, { label: "Profit & Loss" }]}>
      <ProfitLossClient />
    </AuthenticatedLayout>
  );
}
