...
import ExpensesReportClient from "./client";
...
export default async function ExpensesReportPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Expenses Report" breadcrumbs={[{ label: "POS Dashboard", url: "/pos/dashboard" }, { label: "Reports", url: "/reports/sales" }, { label: "Expenses" }]}>
