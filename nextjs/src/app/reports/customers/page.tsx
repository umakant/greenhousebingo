...
import CustomersReportClient from "./client";
...
export default async function CustomersReportPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Customers Report" breadcrumbs={[{ label: "POS Dashboard", url: "/pos/dashboard" }, { label: "Reports", url: "/reports/sales" }, { label: "Customers" }]}>
