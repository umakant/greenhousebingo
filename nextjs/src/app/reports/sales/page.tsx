...
export default async function SalesReportPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Sales Report" breadcrumbs={[{ label: "POS Dashboard", url: "/pos/dashboard" }, { label: "Reports", url: "/reports/sales" }, { label: "Sales" }]}>
      <SalesReportClient />
    </AuthenticatedLayout>
  );
}
