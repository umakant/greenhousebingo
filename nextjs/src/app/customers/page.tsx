...
import PosCustomersClient from "./client";
...
export default async function PosCustomersPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Customers" breadcrumbs={[{ label: "POS Dashboard", url: "/pos/dashboard" }, { label: "Customers" }]}>
      <PosCustomersClient />
    </AuthenticatedLayout>
  );
}
