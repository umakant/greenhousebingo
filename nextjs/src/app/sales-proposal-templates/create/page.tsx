...
export default async function CreateSalesProposalTemplatePage() {
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[
        ...
        { label: t("Create Proposal Template") },
      ]}
      pageTitle={t("Create Proposal Template")}
    >
      <SalesProposalTemplateForm />
    </AuthenticatedLayout>
  );
}
