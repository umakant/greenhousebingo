...
import PosExpensesClient from "./client";
...
export default async function PosExpensesPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Expenses" breadcrumbs={[{ label: "POS Dashboard", url: "/pos/dashboard" }, { label: "Expenses" }]}>
      <PosExpensesClient />
    </AuthenticatedLayout>
  );
}
