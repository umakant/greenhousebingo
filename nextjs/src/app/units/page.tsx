...
import PosUnitsClient from "./client";

export default async function PosUnitsPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Units" breadcrumbs={[{ label: "Accounting", url: "/account" }, { label: "Units" }]}>
      <PosUnitsClient />
    </AuthenticatedLayout>
  );
}
