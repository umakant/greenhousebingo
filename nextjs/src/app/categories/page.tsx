...
import PosCategoriesClient from "./client";
...
export default async function PosCategoriesPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Categories" breadcrumbs={[{ label: "Accounting", url: "/account" }, { label: "Categories" }]}>
      <PosCategoriesClient />
    </AuthenticatedLayout>
  );
}
