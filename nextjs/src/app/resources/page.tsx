...
import SuperadminResourcesAdmin from "@/components/admin/superadmin-resources-admin";
...
export default async function SuperadminResourcesPage() {
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[{ label: t("Resources") }]}
      pageTitle={t("Resources")}
    >
      <SuperadminResourcesAdmin />
    </AuthenticatedLayout>
  );
}
