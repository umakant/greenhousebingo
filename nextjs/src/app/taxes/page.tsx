...
import PosTaxesClient from "./client";

export default async function PosTaxesPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Taxes" breadcrumbs={[{ label: "Accounting", url: "/account" }, { label: "Taxes" }]}>
      <PosTaxesClient />
    </AuthenticatedLayout>
  );
}
