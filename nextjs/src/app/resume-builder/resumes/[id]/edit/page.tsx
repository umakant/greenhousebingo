...
export default async function EditResumePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[{ label: t("Resume Builder"), url: "/resume-builder" }, { label: t("Resumes"), url: "/resume-builder/resumes" }, { label: t("Edit Resume") }]}
      pageTitle={t("Edit Resume")}
    >
      <ResumeBuilderCreate resumeId={id} />
    </AuthenticatedLayout>
  );
}
