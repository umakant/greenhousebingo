...
import PosCalendarClient from "./client";
...
export default async function PosCalendarPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Sales Calendar" breadcrumbs={[{ label: "POS Dashboard", url: "/pos/dashboard" }, { label: "Calendar" }]}>
      <PosCalendarClient />
    </AuthenticatedLayout>
  );
}
