...
import PosTerminalClient from "./client";
...
export default async function PosTerminalPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="POS Terminal" breadcrumbs={[{ label: "Dashboard", url: "/pos/dashboard" }, { label: "POS Terminal" }]}>
      <PosTerminalClient />
    </AuthenticatedLayout>
  );
}
