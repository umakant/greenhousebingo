...
import AccountVendorsAdmin from "@/components/account/account-vendors-admin";
import { safeJsonParse } from "@/lib/authz";
import { decodePermissions } from '@/lib/read-user-cookies';
import { t } from "@/lib/admin-t";


export default async function AccountVendorsPage() {
  ...
  return (
    ...
    >
      <AccountVendorsAdmin permissions={permissions} />
    </AuthenticatedLayout>
  );
}
