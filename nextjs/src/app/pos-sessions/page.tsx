...
import PosSessionsClient from "./client";
...
export default async function PosSessionsPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="POS Sessions" breadcrumbs={[{ label: "POS Dashboard", url: "/pos/dashboard" }, { label: "POS Sessions" }]}>
      <PosSessionsClient />
    </AuthenticatedLayout>
  );
}
