...
import { WaterIceLandingCms } from "@/components/waterice/waterice-landing-cms";
...
export default async function WaterIceLandingCmsPage() {
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumbs={[{ label: t("CMS") }, { label: t("Water Ice Landing") }]}
      pageTitle={t("Water Ice Landing Page")}
    >
      <WaterIceLandingCms />
    </AuthenticatedLayout>
  );
