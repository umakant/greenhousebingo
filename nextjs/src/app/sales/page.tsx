...
import PosSalesClient from "./client";
...
export default async function PosSalesPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Sales" breadcrumbs={[{ label: "POS Dashboard", url: "/pos/dashboard" }, { label: "Sales" }]}>
      <PosSalesClient />
    </AuthenticatedLayout>
  );
}
