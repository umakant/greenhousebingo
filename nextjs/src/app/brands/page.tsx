...
import PosBrandsClient from "./client";
...
export default async function PosBrandsPage() {
  ...
  return (
    <AuthenticatedLayout user={{ name, email, roles, permissions, activatedPackages }} pageTitle="Brands" breadcrumbs={[{ label: "Accounting", url: "/account" }, { label: "Brands" }]}>
      <PosBrandsClient />
    </AuthenticatedLayout>
  );
}
