Array.prototype.indexOf || (Array.prototype.indexOf = function(e) {
    ...
    var i = $(this),
        a = i.height();
    return !(i.parent().hasClass("heightkeeper") || i.attr("src") == e || (i.wrap($('<div class="heightkeeper" />').css({
        height: a,
        overflow: "hidden"
    })).stop(!0, !0).animate({
        opacity: 0
    }, 200, function() {
        (i = i.replaceImageWithOneOfNewSrc(e)).imagesLoaded(function() {
            i.stop(!0, !0).animate({
                opacity: 1
    ...
    if (e)
        ...
        $(".selector-wrapper select").filter(function() {
            return "" == $(this).val()
        }).length > 0 && (o = jQuery("#add").data("addtocart")), jQuery("#price del").remove(), jQuery("#backorder").addClass("hidden"), jQuery("#add").html(o).addClass("disabled").attr("disabled", "disabled")
    }
    if (e && e.featured_image) {
        var r = Shopify.Image.removeProtocol(e.featured_image.src).split("?");
        $(".thumbnails a.thumbnail").filter('[href*="' + r[0] + '"]').trigger("click")
    }
    e && e.sku ? $("#sku").removeClass("hidden").find("span").html(e.sku) : $("#sku").addClass("hidden").find("span").html("")
}, jQuery(window).resize(function() {
    roar.handleSticky(), roar.detectOptions(), window.slideshow_scale ? roar.mockupCaptionSlider2() : roar.mockupCaptionSlider(), roar.mockupCaptionVideo(), roar.mockupStaticBlock(), roar.mockupLookbookBlock(), roar.handleProductThumbnailImages(), roar.handlePromotionSlider()
}), $(window).scroll(function() {
    roar.closeThemeCtl2()
}), jQuery(document).ready(function() {
    roar.handlePromotionSlider();
...
var ctlCloseButton = '<a class="close-ctl" href="javascript:;" data-ctl-close><i class="zmdi zmdi-close"></i></a>',
    roar = {
        timeout: null,
        init: function() {
            this.megaMenu(), this.mockupCaptionVideo(), this.detectOptions(), this.handleHomepage(), this.handleTooltip(), this.handleCountdown(), this.handleTabs(), this.handleSearch(), this.handleSliding(), this.callbackSearchMobile(), this.handleMenuMobile(), this.handleCartSidebar(), this.handleSlideshow(), this.handleMap(), this.handleScrollToTop(), this.handleSmoothScroll(), this.mapFilters(), this.handleVideo(), this.materialEffect(), this.closeThemeCtlEvents(), this.handleThumbTip(), this.handleEffects(), this.handleSticky(), this.handleQuickshop(), this.handleMore(), this.handleInfiniteScoll(), this.handleProductThumbnailImages(), fakewaffle.responsiveTabs(["xs"])
        },
        ...
        handlePromotionSlider: function() {
            if ($(".slidetabs-wrapper").length > 0) {
                var e = $(".slidetabs-wrapper").data("slide_delay"),
                    t = $(".slidetabs-wrapper").data("step_interval");
                SlideTab.initialize($(".slidetab-slide-container"), $(".slidetab-tab-container"), {
                    smooth: !1,
                    smoothSpeed: 500,
                    slideDelay: e,
                    stepInterval: t / 60,
        ...
        handleProductThumbnailImages: function() {
            $(".templateProduct .thumbnails.owl-carousel").length > 0 && $(".templateProduct .thumbnails.owl-carousel").owlCarousel({
                items: $(".templateProduct .thumbnails.owl-carousel").data("items"),
                nav: !0,
        ...
        handleQuickshop: function() {
            ...
            $(window).resize(resizeColorBox), window.addEventListener("orientationchange", resizeColorBox, !1), roar.isMobile() || ($(document).on("initzoom", ".product-gallery .main .main-img-link", function() {
                ...
                if (1 == e.length) {
                    var t = !1;
                    $("body").hasClass("templateProduct") && (t = !0);
                    var i = ($(this).find(".product-form"), window.products["id" + $(this).data("product-id")]);
                    new Shopify.OptionSelectors(e.attr("id"), {
                        product: i,
                        onVariantSelected: selectCallback,
                        enableHistoryState: t
                    }), i.available && i.options.length > 1 && Shopify.linkOptionSelectors(i), roar.createVariantsSwatch(i, $(this)), 1 == i.variants.length && "Default Title" == i.variants[0].title && jQuery(".selector-wrapper").hide();
                    for (var a = !1, o = 0; o < i.variants.length; o++) {
                        var r = i.variants[o];
                        if (r.available && 0 == a) {
                            a = !0;
                            for (var n = 0; n < r.options.length; n++) $(".single-option-selector:eq(" + n + ")").val(r.options[n]).trigger("change")
                        }
                    }
                }
        ...
        handleSticky: function() {
            if (jQuery("#header.sticky-header").length > 0) {
                ...
                window.innerWidth > 0 ? jQuery("#header_nav").css("height", i) : jQuery("#header_nav").css("height", "auto"), jQuery(window).scroll(function() {
                    var i = jQuery(this).scrollTop(),
                        a = window.innerWidth;
                    i > t && a > 0 ? (jQuery("#header_nav").addClass("is-sticky"), jQuery("#site-navigation").addClass("fadeInDown")) : (jQuery("#header_nav").removeClass("is-sticky"), jQuery("#site-navigation").removeClass("fadeInDown"));
                    var o = jQuery(this).scrollTop(),
                        r = 800;
                    if (jQuery("#home-slider").length > 0) {
                        var n = jQuery("#home-slider");
                        r = n.offset().top + n.height() + 100
                    }
        ...
        hoverIntent: function() {
            jQuery(".nav-dropdown-parent").hoverIntent(function() {
                var e = jQuery(this);
                e.find(".nav-dropdown").slideDown(400, "jswing", function() {
                    e.addClass("active")
                })
            }, function() {
                var e = jQuery(this);
                e.find(".nav-dropdown").slideUp(400, "jswing", function() {
                    e.removeClass("active")
                })
            })
        },
        handleEffects: function() {
            $(".animated:not(.shown)").exists() && (setTimeout(function() {
                roar.loadingEffects()
            ...
            jQuery(".tip_holder_big").each(function() {
                ...
                jQuery(this).hover(function() {
                    ...
                    var i = t.pageX + 60,
                        a = t.pageY - 50,
                        o = e.width(),
                        r = (e.height(), jQuery(window).width() - (i + o));
                    jQuery(window).height(), 50 > r && (i = t.pageX - o - 60), e.css({
                        left: i,
                        top: a
                    })
                })
        ...
        showThemeCtl2: function(e) {
            roar.closeThemeCtl2(!0), jQuery(e).addClass("reveal2")
        },
        ...
        closeThemeCtlEvents: function() {
            jQuery(document).on("click", "body:not(.ctl-active) a[data-ctl-toggle]", function(e) {
                e.preventDefault(), jQuery(jQuery(this).data("ctl-toggle")).removeClass("unreveal").addClass("reveal").find(":input[type=search]:visible:first").focus(), jQuery(this).addClass("active"), roar.isPageScrollin() && jQuery("body").css("padding-right", jQuery.scrollBarWidth()), jQuery("body").addClass("ctl-active")
            }).on("keyup", function(e) {
        ...
        megaMenu: function() {
            jQuery(".is-mega .mega-menu.style_1 .item").hoverIntent(function() {
                ...
                t.removeClass("hover"), e.addClass("hover"), i.fadeIn(400, function() {
                    e.closest(".mega-menu").find(".item:not(.hover) .mega-menu-content > .wrap").hide()
                })
        ...
        handleVideo: function() {
            jQuery(".responsive-video iframe").each(function() {
        ...
        mapSingleSortby: function() {
            jQuery("#module-content").on("change", ".advanced-sortby .field", function(e) {
                ...
                Shopify.queryParams.sort_by = t, roar.filterAjaxClick(), e.preventDefault()
            })
        },
        ...
        filterGetContent: function(e) {
            jQuery.ajax({
                ...
                success: function(t) {
                    ...
                    }, 100), jQuery("body").removeClass("is_loading"), roar.loadingEffects(), roar.mapClearFilter(), roar.mapClearAllFilter(), roar.handleTooltip(), roar.handleReviews(), currenciesCallbackSpecial("span.money")
                },
                error: function() {
        ...
        buildProductItem: function() {
            jQuery("select.product-select").each(function(e) {
                ...
                jQuery(this).attr("id", "product-select-" + t).attr("data-id", t)
            })
        },
        createVariantsSwatch: function(e, t) {
            ...
            if (window.swatch_size && a.push("Size"), window.swatch_color && (a.push("Color"), a.push("Colour")), a.length > 0) {
                var o = !1,
                    r = !1,
                    n = 0,
                    s = window.asset_url.substring(0, window.asset_url.lastIndexOf("?")),
                    l = window.asset_url.substring(window.asset_url.lastIndexOf("?"), window.asset_url.length);
                for (i = 0; i < e.options.length; i++) {
                    var d = "";
                    if (d = "object" == typeof e.options[i] ? e.options[i].name : e.options[i], o = !1, r = !1, a.indexOf(d) > -1) {
                        o = !0, n = i;
                        var c = d.toLowerCase();
                        if (/color|colour/i.test(c) && (r = !0), o) {
                            var u = "",
                                h = "";
                            /size/i.test(d.toLowerCase()) && window.size_chart && (h = '<a id="size_chart_trigger" href="#" class="sizechart-ctl" data-ctl-toggle="#sizechart-ctl">' + window.size_chart_txt + "</a>"), u += '<div class="swatch ' + c + ' clearfix" data-option-index="' + n + '">', u += '<div class="header"><span>' + d + "</span>" + h + "</div><div>";
                            var m = new Array;
                            for (j = 0; j < e.variants.length; j++) {
                                var f = e.variants[j],
                                    ...
                                    g = "swatch-" + n + "-" + y;
                                m.indexOf(p) < 0 && (u += '<div data-value="' + p + '" class="swatch-element ' + (r ? "color" : "") + y + (f.available ? " available " : " soldout ") + '">', r && (u += '<div class="tooltip">' + p + "</div>"), u += '<input id="' + g + '" type="radio" name="option-' + n + '" value="' + p + '"' + (0 == j ? " checked " : "") + (f.available ? "" : " disabled") + "/>", r ? (u += '<label for="' + g + '" class="img"><i style="background-color:' + y + "; background-image: url(" + s + y + ".png" + l + ')">', u += '<img class="crossed-out" src="' + s + 'soldout.png" />', u += "</i></label>") : (u += '<label for="' + g + '">' + p, u += '<img class="crossed-out" src="' + s + 'soldout.png" />', u += "</label>"), u += "</div>", m.push(p))
                            }
        ...
        isMobile: function() {
            ...
            return !!(Modernizr.touch || e.match(/(iphone|ipod|ipad)/) || e.match(/(android)/) || e.match(/(iemobile)/) || e.match(/iphone/i) || e.match(/ipad/i) || e.match(/ipod/i) || e.match(/blackberry/i) || e.match(/bada/i) || e.match(/windows phone/i) || e.match(/webOS/i))
        },
        ...
        mockupCaptionVideo: function() {
            if (jQuery("#home-video").length) {
                ...
                var n = jQuery("#home-video").height() / 2 - jQuery("#home-video .video_width").height() / 2;
        ...
        mockupCaptionSlider2: function() {
            if (window.slideshow_show && jQuery("#home-slider").length) {
                ...
                jQuery("#home-slider .caption-content").each(1200 > e ? function() {
                    var t = jQuery(this).data("min"),
                        i = jQuery(this).data("max") * e / 1200,
                        a = 30 * e / 1200;
                    t > i && (i = t), jQuery(this).css({
                        "font-size": i,
                        "padding-bottom": a
                    })
                } : function() {
                ...
                var t = jQuery("#home-slider").height() / 2;
                jQuery("#home-slider .slide-caption").each(function() {
                    if (1 == jQuery(this).data("position")) {
                        var i = jQuery(this).data("left"),
                            a = jQuery(this).data("top"),
                            o = jQuery(this).data("right"),
                            r = jQuery(this).data("bottom"),
                            n = jQuery(this).data("width"),
                            s = jQuery(this).data("align");
                        void 0 === a && (a = "auto"), void 0 === r && (r = "auto"), void 0 === i && (i = "auto"), void 0 === o && (o = "auto"), 1200 > e && ("auto" != i && (i = i * e / 1200), "auto" != a && (a = a * e / 1200), "auto" != o && (o = o * e / 1200), "auto" != r && (r = r * e / 1200), n = n * e / 1200), jQuery(this).css({
                            top: a,
                            left: i,
                            bottom: r,
                            right: o,
        ...
        mockupCaptionSlider: function() {
            if (window.slideshow_show && jQuery("#home-slider").length) {
                ...
                jQuery("#home-slider .caption-content").each(767 > e ? function() {
                    var t = jQuery(this).data("min"),
                        i = jQuery(this).data("max"),
                        a = i,
                        o = 30 * e / 767;
                    i > 50 && (a = 50), t > a && (a = t), jQuery(this).css({
                        "font-size": a,
                        "padding-bottom": o
                    })
                } : function() {
        ...
        notifyIE8Users: function() {
            (jQuery("html").hasClass("ie7") || jQuery("html").hasClass("ie7")) && (window.notify_ie8_page ? jQuery.ajax({
                type: "GET",
                ...
                dataType: "html"
            }) : jQuery("body").html("<h1>Unsupported Browser</h1>").show())
        },
        ...
        mockupStaticBlock: function() {
            jQuery(".static-surround").length && jQuery(".static-surround").find("[data-size]").each(function() {
                var e = jQuery(this);
                if (roar.getWidthBrowser() < 1200) {
                    var t = window.general_font_size,
                        i = (a = e.data("size")) * (e.data("bottom"), roar.getWidthBrowser()) / 1200;
                    t > i && (i = t), e.css({
                        "font-size": i
                    })
                } else {
        ...
        mockupLookbookBlock: function() {
            jQuery(".widget-lookbook").length && jQuery(".widget-lookbook").find("[data-size]").each(function() {
                var e = jQuery(this);
                if (roar.getWidthBrowser() < 1200) {
                    var t = window.general_font_size,
                        i = (a = e.data("size")) * (e.data("bottom"), roar.getWidthBrowser()) / 1200;
            ...
            jQuery("#sidebar .featured-products").length && jQuery("#sidebar .featured-products").owlCarousel({
                ...
                jQuery.ajax({
                    ...
                    success: function(e) {
                        ...
                        jQuery(".cat-grid").empty().append(a).append(t), jQuery(e).find(".infinite_scoll a").length ? jQuery(".infinite_scoll").last().html(jQuery(e).find(".infinite_scoll").last().html()) : jQuery(".infinite_scoll").empty(), jQuery("body").removeClass("is_loading"), roar.loadingEffects(), roar.handleReviews()
                    },
                    dataType: "html"
                })
