...
export const plans = [
  {
    ...
    price: 49,
    setup: 99,
    tagline: "Perfect for a first local rep",
    features: [
  ...
  },
  {
    ...
    price: 199,
    setup: 0,
    tagline: "For established reps",
    features: [
      "Unlimited events",
      "Unlimited venues",
      "Full custom branding",
      "Featured placement (rotational)",
      "Priority support",
      "Advanced analytics",
    ],
  },
  {
    name: "Enterprise / Regional Partner",
    price: 499,
    setup: 0,
    tagline: "Own a full region",
    features: [
      "Multi-city coverage",
      "Sub-rep management",
