...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service — The Social Greenhouse" },
      {
        name: "description",
        content:
          "The Terms of Service governing your access to and use of The Social Greenhouse Platform, Software, Website, and Services.",
      },
      { property: "og:title", content: "Terms of Service — The Social Greenhouse" },
      {
        property: "og:description",
        content:
          "Read our full Terms of Service — eligibility, subscriptions, billing, IP, disclaimers, liability, dispute resolution, and more.",
      },
    ],
  }),
  component: TermsPage,
